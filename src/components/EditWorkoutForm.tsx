...
// Exercise form component (same as AddWorkoutForm)
...
export default function EditWorkoutForm({
  ...
  useEffect(() => {
    const exerciseData = workout.workoutExercises
      .sort((a, b) => a.order - b.order)
      .map((we) => ({
        name: we.name,
        currentWeight: we.currentWeight.toString(),
        unit: we.unit as 'kg' | 'lbs',
        minReps: we.minReps.toString(),
        maxReps: we.maxReps.toString(),
        weightIncrement: we.weightIncrement.toString() || '2.5',
      }))
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
          <DialogHeader>
            ...
            <DialogDescription>
              Update your workout exercises and schedule.
            </DialogDescription>
          </DialogHeader>
